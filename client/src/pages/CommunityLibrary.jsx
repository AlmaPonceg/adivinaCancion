        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="px-2.5 py-1.5 rounded-xl border border-[#EAE3D5] bg-[#FAF8F5] hover:bg-white text-xs font-bold text-[#746B8A] hover:text-[#181226] transition-all flex items-center gap-1.5 cursor-pointer shadow-2xs"
              title="Ver planes y suscripciones"
            >
              <svg className="w-3.5 h-3.5 text-[#46178F]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
