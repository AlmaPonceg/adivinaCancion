  ...
  return (
    <div className="relative flex flex-col items-center justify-center p-2 select-none touch-none">
      ...
      <div className="relative p-5 sm:p-7 rounded-[42px] bg-[#111827] border-2 border-slate-700/80 shadow-[0_20px_50px_rgba(0,0,0,0.6),inset_0_2px_4px_rgba(255,255,255,0.06)]">
        ...
        {/* Outer Arcade Chrome Bezel & Socket Well */}
        <div className="relative w-52 h-52 sm:w-60 sm:h-60 rounded-full flex items-center justify-center bg-gradient-to-b from-slate-600 via-slate-400 to-slate-600 p-1.5 shadow-[inset_0_12px_24px_rgba(0,0,0,0.8),0_4px_12px_rgba(0,0,0,0.5)]">
          <div className="w-full h-full rounded-full bg-gradient-to-b from-slate-950 to-slate-900 border-2 border-slate-800 flex items-center justify-center relative">
              ...
              <div
                ...
                style={{
                  ...
                  background: isMyTurn
                    ...
                    : canBuzz
                    ? `radial-gradient(circle at 35% 30%, #FFFFFF 0%, ${teamColor} 35%, #0B0F19 100%)`
                    : isBlocked
                    ? 'radial-gradient(circle at 35% 30%, #64748B 0%, #334155 70%, #0B0F19 100%)'
                    : 'radial-gradient(circle at 35% 30%, #475569 0%, #1E293B 70%, #0B0F19 100%)',
                }}
              >
                {/* Tightened Convex Glass Reflection Arc */}
                <div className="absolute top-1 left-1/2 -translate-x-1/2 w-32 h-14 bg-gradient-to-b from-white/30 via-white/10 to-transparent rounded-full pointer-events-none" />
                ...
                <div className="relative z-10 flex flex-col items-center justify-center text-center">
                  ...
                  {/* Arcade Label */}
                  <span
                    className={`font-heading font-black uppercase tracking-widest text-xs sm:text-sm drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] ${
                      isMyTurn
